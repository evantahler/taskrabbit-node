...
taskrabbit.prototype.taskConverstaions = function(accessToken, taskID, callback){
  var self = this;
  self.makeRequest('GET', "tasks/" + taskID + "/converstaions", accessToken, payload, function(error, data){
    if(typeof callback === "function") { callback(error, data); }
  });
}
...
taskrabbit.prototype.taskOfferAccept = function(accessToken, taskID, offerID, callback){
  var self = this;
  self.makeRequest('POST', "tasks/" + taskID + "/offers/" + offerID + "/accept", accessToken, payload, function(error, data){
    if(typeof callback === "function") { callback(error, data); }
  });
}
